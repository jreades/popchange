...
DataSummary <- function(oa2011_weighted, grid, time, longLog = FALSE){
  #Filename
  ...
  #number of Grids
    cat("\n", "Number of non Split Grid Cells:",length(grid@data$ID))
  #number of regions
  ...
  #Save to log file
    ...
    cat(paste0("Number of non Split Grid Cells: ",length(grid@data$ID)), file = filename, sep = "\n", append = TRUE)
